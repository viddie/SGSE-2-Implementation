...
app.use('/docs/docs-offers', swaggerUi.serveFiles(offers, options), swaggerUi.setup(offers));
app.use('/docs/docs-email', swaggerUi.serveFiles(email, options), swaggerUi.setup(email));
